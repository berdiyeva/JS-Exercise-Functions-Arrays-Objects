...
//make variable to hold cars into before being passed to german variable:
       let hold = [];
//check for german or not. if german, put in hold variable to be passed at end of iteration to german variable:
